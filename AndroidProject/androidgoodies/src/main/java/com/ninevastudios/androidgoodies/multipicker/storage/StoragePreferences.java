package com.ninevastudios.androidgoodies.multipicker.storage;
...
public class StoragePreferences {
    ...
    private final static String FILE = "com.ninevastudios.androidgoodies.multipicker.multipicker.preferences";
